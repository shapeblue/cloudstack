...
public interface OvnMeshNetworkService {
    OvnMeshNetworkVO createMeshNetwork(CreateMeshNetworkCmd cmd);
    OvnMeshNetworkVO updateMeshNetwork(UpdateMeshNetworkCmd cmd);
    boolean deleteMeshNetwork(DeleteMeshNetworkCmd cmd);
    boolean enableMeshNetwork(EnableMeshNetworkCmd cmd);
    boolean disableMeshNetwork(DisableMeshNetworkCmd cmd);
    List<MeshNetworkResponse> listMeshNetworks(ListMeshNetworksCmd cmd);
    MeshNetworkResponse createMeshNetworkResponse(OvnMeshNetworkVO member);
}
