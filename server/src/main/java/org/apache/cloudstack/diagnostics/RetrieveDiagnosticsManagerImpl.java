...
public class RetrieveDiagnosticsManagerImpl extends ManagerBase implements RetrieveDiagnosticsManager, Configurable {
    ...
    public boolean configure(String name, Map<String, Object> params) throws ConfigurationException {
        ...
        String _disableThreshold = NumbersUtil.parseFloat((String)params.get("retrieveDiagnostics.disablethreshold"),0.95f);
        filePath = (String)params.get("retrieveDiagnostics.filepath");
        fileAge = NumbersUtil.parseLong((String)params.get("retrieveDiagnostics.max.fileage"), 86400);
        intervalGC = NumbersUtil.parseLong((String)params.get("retrieveDiagnostics.gc.interval"), 86400);
        //enabledGC = (String)params.get("retrieveDiagnostics.gc.enabled");
