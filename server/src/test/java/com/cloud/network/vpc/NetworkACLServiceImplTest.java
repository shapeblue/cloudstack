...
public class NetworkACLServiceImplTest {
    ...
    private void createNetworkACLItemTestForNumberAndExecuteTest(Integer number) {
        ...
        //inOrder.verify(networkAclServiceImpl).validateAndCreateNetworkAclRuleAction(anyString());
