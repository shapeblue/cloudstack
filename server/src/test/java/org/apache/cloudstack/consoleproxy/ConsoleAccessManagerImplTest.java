...
public class ConsoleAccessManagerImplTest {
    ...
    public void composeConsoleAccessEndpointReturnsWithoutPersistWhenConsoleConnectionDetailsAreValidDirect() {
        ...
        ConsoleEndpoint endpoint = consoleAccessManager.composeConsoleAccessEndpoint("url", vm, host, "", "", "");

        Mockito.verify(consoleAccessManager, Mockito.never()).persistConsoleSession(Mockito.anyString(), Mockito.anyLong(), Mockito.anyLong(), Mockito.anyString());
