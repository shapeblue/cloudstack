...
public class UpdateVMScheduleCmd extends BaseCmd {
    ...
    public long getEntityOwnerId() {
        ...
        if (schedule == null) {
            throw new InvalidParameterValueException(String.format("Unable to find schedule by id=%d", getId()));
        }
        if (!ApiCommandResourceType.VirtualMachine.equals(schedule.getResourceType())) {
            throw new InvalidParameterValueException(String.format("Schedule id=%d is not a VM schedule", getId()));
        }
