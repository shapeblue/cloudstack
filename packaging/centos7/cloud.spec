...
mvn -Psystemvm,developer $FLAGS clean package -DskipTests=true
...
install -D client/target/pythonlibs/jasypt-*.jar ${RPM_BUILD_ROOT}%{_datadir}/%{name}-common/lib/
...
%attr(0644, root, root) %{_datadir}/%{name}-common/lib/jasypt-*.jar
