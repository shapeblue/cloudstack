...
install -D systemvm/dist/agent.zip ${RPM_BUILD_ROOT}%{_datadir}/%{name}-common/vms/agent.zip
install -D systemvm/dist/cloud-scripts.tgz ${RPM_BUILD_ROOT}%{_datadir}/%{name}-common/vms/cloud-scripts.tgz
