...
public class RetrieveZipFilesCommand extends StorageNfsVersionCommand {
    ...
    public RetrieveZipFilesCommand(String copyCommand, Boolean secCleanup) {
        this.copyCommand = copyCommand;
    ...
    public RetrieveZipFilesCommand(long volumeId, String volumePath, StoragePool pool, String secondaryStorageURL, boolean toSecondaryStorage, int wait,
