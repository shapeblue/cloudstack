...
public class VRScripts {
    ...
    public static final String ROUTER_RETRIEVEFILES = "router.py";
    ...
    // Script for Retrieve Diagnostics
    public static final String RETRIEVE_DIAGNOSTICS = "retrieve_diagnostics.py";
