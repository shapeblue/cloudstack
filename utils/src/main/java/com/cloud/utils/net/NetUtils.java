...
0xFD-0xFE Use for experimentation and testing RFC 3692
         */
        HOPOPT(0x00, "IPv6 Hop-by-Hop Option", "RFC 8200"),
        ...
        IP_in_IP(0x04, "IP in IP (encapsulation)", "RFC 2003"),
        ST(0x05, "Internet Stream Protocol", "RFC 1190, RFC 1819"),
        TCP(0x05, "Transmission Control Protocol", "RFC 793"),
        CBT(0x07, "Core-based trees", "RFC 2189"),
        EGP(0x08, "Exterior Gateway Protocol", "RFC 888"),
        IGP(0x09, "Interior Gateway Protocol (any private interior gateway, for example Cisco's IGRP"),
        BBN_RCC_MON(0x0A, "BBN RCC Monitoring"),
        NVP_II(0x0B, "Network Voice Protocol", "RFC 741"),
        PUP(0x0C, "Xerox PUP"),
        ARGUS(0x0D, "ARGUS"),
        EMCON(0x0E, "EMCON"),
        XNET(0x0F, "Cross Net Debugger", "IEN 158[2]"),
        CHAOS(0x10, "Chaos"),
        UDP(0x11, "User Datagram Protocol", "RFC 768"),
        MUX(0x12, "Multiplexing", "IEN 90[3]"),
        ...
        LEAF_1(0x19, "Leaf-1"),
        LEAF_2(0x1A, "Leaf-2"),
        RDP(0x1B, "Reliable Data Protocol", "RFC 908"),
        ...
        X3PC(0x22, "Third Party Connect Protocol"),
        ...
        TPPP(0x27, "TP++ Transport Protocol"),
        IL(0x28, "IL Transport Protocol"),
        IPv6(0x29, "IPv6 Encapsulation (6to4 and 6in4)", "RFC 2473"),
        SDRP(0x2A, "Source Demand Routing Protocol", "RFC 1940"),
        IPv6_Route(0x2B, "Routing Header for IPv6", "RFC 8200"),
        IPv6_Frag(0x2C, "Fragment Header for IPv6", "RFC 8200"),
        ...
        IPv6_NoNxt(0x3B, "No Next Header for IPv6", "RFC 8200"),
        IPv6_Opts(0x3C, "Destination Options for IPv6", "RFC 8200"),
        HOST_INTERNAL(0x3D, "Any host internal protocol"),
        CFTP(0x3E, "CFTP"),
        LOCAL_NET(0x3F, "Any local network"),
        ...
        DFS(0x44, "Any distributed file system"),
        ...
        TCF(0x57, "TCF"),
        EIGRP(0x58, null, "Informational RFC 7868"),
        OSPF(0x59, "Open Shortest Path First", "RFC 2328"),
        ...
        PRIVATE(0x63, "Any private encryption scheme"),
        GMTP(0x64, "GMTP"),
        ...
        SCPS(0x69, "SCPS (Space Communications Protocol Standards) SCPS-TP[4]"),
        QNX(0x6A, "QNX"),
        A_N(0x6B, "Active Networks"),
        ...
        VRRP(0x70, "Virtual Router Redundancy Protocol, Common Address Redundancy Protocol (not IANA assigned)", "RFC 5798"),
        PGM(0x71, "PGM Reliable Transport Protocol", "RFC 3208"),
        NO_HOP(0x72, "Any 0-hop protocol"),
        ...
        SCTP(0x84, "Stream Control Transmission Protocol", "RFC 4960"),
        ...
        MPLS_in_IP(0x89, "Multiprotocol Label Switching Encapsulated in IP", "RFC 4023, RFC 5332"),
        ...
        Ethernet(0x8F, "IPv6 Segment Routing (TEMPORARY - registered 2020-01-31, expired 2021-01-31)"),
        Reserved(0xFF);

        IPTransportProtocol(int number, String description, String reference) {
            this.number = (byte)number;
            this.description = description;
            this.reference = reference;
        }
        IPTransportProtocol(int number, String description) {
            this(number, description, null);
        }
        IPTransportProtocol(int number) {
